...
public class TimedScaleAuto extends CommandGroup {
  private DriveSubsystem driveSubsystem;
  private ArmSubsystem armSubsystem;
  private GrabberSubsystem grabberSubsystem;
  
  public TimedScaleAuto(DriveSubsystem driveSubsystem, ArmSubsystem armSubsystem, GrabberSubsystem grabberSubsystem) {
